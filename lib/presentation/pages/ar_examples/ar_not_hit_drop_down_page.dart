...
class InfoCardAR extends StatelessWidget {
  ...
  /// 🔹 Nuevo: callback para capturar (null => botón deshabilitado)
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final bool captureEnabled = onCapturePressed != null;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // 🔹 Botón centrado para capturar (habilitado solo si hay modelo)
            Row(
              children: [
                const Spacer(),
                ElevatedButton.icon(
